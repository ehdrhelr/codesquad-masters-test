...
public class CounterClockwise {
    ...
    public static String[][][] rotateTopToLeft(
                    String[][][] newCube, String[][][] cube, int targetDimension) {
    ...
    public static String[][][] rotateRightToTop(
                    String[][][] newCube, String[][][] cube, int targetDimension) {
        for (int i = 0; i < cube[targetDimension].length; i++) {
    ...
    public static String[][][] rotateBottomToRight(
                    String[][][] newCube, String[][][] cube, int targetDimension) {
        for (int i = 0; i < cube[targetDimension].length; i++) {
    ...
    public static String[][][] rotateLeftToBottom(
                    String[][][] newCube, String[][][] cube, int targetDimension) {
        for (int i = 0; i < cube[targetDimension].length; i++) {
